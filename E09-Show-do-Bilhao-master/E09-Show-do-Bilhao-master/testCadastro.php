...
$user = new Player($_POST['name'], $_POST['password'], $_POST['email'], $_POST['login']);
$insert = InsereUsuarioNoArquivo("json/player.json", $user);

if($insert)header("Location: loginCadastrado.php");
